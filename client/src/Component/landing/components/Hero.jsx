...
function Hero() {
  ...
  const handleClick = () => {
    navigate("/login"); // Navigates to the About page when clicked
  }; 
    ...
    if (location.state && location.state.scrollTo) {
      setTimeout(() => {
        ...
        if (targetElement) {
          ...
          // Clear the state after scrolling so that a refresh won't trigger the scroll again.
...
<div className=" relative p-6">
      ...
      <div className="relative flex items-center justify-center w-full min-[400px]:-mt-[rem] -mt-[2.5rem] sm:-mt-[16rem] md:-mt-[7rem] lg:-mt-[14rem] xl:-mt-[12rem] 2xl:-mt-[19rem] z-30">
        <img
          src={heroimage}
          alt="heroimage"
