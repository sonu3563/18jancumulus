...
showAlert("error", "Failed", data.message || "Failed to update access");
  ...
  return (
    <div className="p-4">
      {designee ? (
        <div>
          <div className="text-2xl font-normal text-[#1F1F1F] mb-2">
                          ...
                          {file.files?.map((singleFile, fileIndex) => (
                            ...
                            >
                              <div
                                ...
                                <h1
                                  className=" flex items-center bg-gray-100 max-w-32 overflow-hidden p-2 rounded cursor-pointer gap-0 text-sm font-bold">
                              ...
                              <div>
                                <h1 className="px-4 py-2 font-semibold text-gray-500 text-sm">
                                  {singleFile.access || "Unknown"}
                                </h1>
                              </div>
