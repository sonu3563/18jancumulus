...
useEffect(() => {
  ...
  return (
    <div className="bg-gray-100 py-10">
     <h1 class="text-3xl font-bold font-serif text-center mb-4">
...
<div class="flex justify-center items-center text-gray-600 mb-6">
  <span class="px-3 font-semibold">Yearly</span>
  <span class="text-blue-500 text-[0.85rem]">(Save Upto 60%)</span>
</div>
