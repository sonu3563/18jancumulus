        ...
        <span className="absolute top-0 right-0 h-2 w-2 bg-red-500 rounded-full"></span>
            ...
            {notificationbar && (
                <motion.div
                    ...
                    className="absolute top-10 right-0 bg-white shadow-lg rounded-lg w-[30rem] py-3 z-50"
                >
                ...
                >
                    ...
                    <div className="flex justify-around">
                        <p className="text-blue-500 cursor-pointer" onClick={handleMarkAsRead}>Mark as Read</p>
